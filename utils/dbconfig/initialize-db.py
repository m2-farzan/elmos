...
try:
    ...
    `weekday_1` int(11) NOT NULL,
    `time_start_1` decimal(10,2) DEFAULT NULL,
    `time_end_1` decimal(10,2) DEFAULT NULL,
    `weekday_2` int(11) DEFAULT NULL,
    `time_start_2` decimal(10,2) DEFAULT NULL,
    `time_end_2` decimal(10,2) DEFAULT NULL,
    `weekday_3` int(11) DEFAULT -1,
    `time_start_3` decimal(10,2) DEFAULT -1.00,
    `time_end_3` decimal(10,2) DEFAULT -1.00,
